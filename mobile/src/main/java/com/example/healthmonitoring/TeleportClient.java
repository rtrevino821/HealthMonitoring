...
//    }
     ...
     * Created by Mario Viviani on 09/07/2014.
     */
    public static class TeleportClient implements DataApi.DataListener,
            MessageApi.MessageListener, NodeApi.NodeListener, GoogleApiClient.ConnectionCallbacks,
            GoogleApiClient.OnConnectionFailedListener {
        ...
        //    private AsyncTask<?,?,?> asyncTask;
        private com.example.healthmonitoring.TeleportClient.OnSyncDataItemTask onSyncDataItemTask;
        private com.example.healthmonitoring.TeleportClient.OnSyncDataItemTask.Builder onSyncDataItemTaskBuilder;
        private com.example.healthmonitoring.TeleportClient.OnSyncDataItemCallback onSyncDataItemCallback;
        private com.example.healthmonitoring.TeleportClient.OnGetMessageTask onGetMessageTask;
        private com.example.healthmonitoring.TeleportClient.OnGetMessageTask.Builder onGetMessageTaskBuilder;
        private com.example.healthmonitoring.TeleportClient.OnGetMessageCallback onGetMessageCallback;
         ...
         * Get the TeleportTask that will be executed when a DataItem is synced
         */
        public com.example.healthmonitoring.TeleportClient.OnSyncDataItemTask getOnSyncDataItemTask() {
            return onSyncDataItemTask;
        }
         ...
         * @param onSyncDataItemTask A Task that extends TeleportTask that should be executed when a DataItem is Synced. Keep in mind it will be executed only once, so you might need to reset it.
         */
        public void setOnSyncDataItemTask(com.example.healthmonitoring.TeleportClient.OnSyncDataItemTask onSyncDataItemTask) {
            this.onSyncDataItemTask = onSyncDataItemTask;
        }
         ...
         * @param onSyncDataItemTaskBuilder A Builder for a task that extends TeleportTask that should be executed when a DataItem is Synced. Keep in mind it will be executed only once, so you might need to reset it.
         */
        public void setOnSyncDataItemTaskBuilder(com.example.healthmonitoring.TeleportClient.OnSyncDataItemTask.Builder onSyncDataItemTaskBuilder) {
            this.onSyncDataItemTaskBuilder = onSyncDataItemTaskBuilder;
        }
         ...
         * @param onSyncDataItemCallback A Task that extends TeleportTask that should be executed when a DataItem is Synced. Keep in mind it will be executed only once, so you might need to reset it.
         */
        public void setOnSyncDataItemCallback(com.example.healthmonitoring.TeleportClient.OnSyncDataItemCallback onSyncDataItemCallback) {
            this.onSyncDataItemCallback = onSyncDataItemCallback;
        }
        ...
        public abstract static class OnSyncDataItemTask extends AsyncTask<DataMap, Void, DataMap> {
            ...
            public abstract static class Builder {
                ...
                public abstract com.example.healthmonitoring.TeleportClient.OnSyncDataItemTask build();
        ...
        public void sendMessage(String path, byte[] payload) {
            //Start a StartTeleportMessageTask with proper Path and Payload
            new com.example.healthmonitoring.TeleportClient.StartTeleportMessageTask().execute(path, payload);
        }
        ...
        public abstract static class OnGetMessageTask extends AsyncTask<String, Void, String> {
            ...
            public abstract static class Builder {
                ...
                public abstract com.example.healthmonitoring.TeleportClient.OnGetMessageTask build();
        ...
        public com.example.healthmonitoring.TeleportClient.OnGetMessageTask getOnGetMessageTask() {
            return onGetMessageTask;
        }

        public void setOnGetMessageTask(com.example.healthmonitoring.TeleportClient.OnGetMessageTask onGetMessageTask) {
            this.onGetMessageTask = onGetMessageTask;
        }
         ...
         * @param onGetMessageTaskBuilder A Builder for a task that extends TeleportTask that should be executed when a DataItem is Synced. Keep in mind it will be executed only once, so you might need to reset it.
         */
        public void setOnGetMessageTaskBuilder(com.example.healthmonitoring.TeleportClient.OnGetMessageTask.Builder onGetMessageTaskBuilder) {
            this.onGetMessageTaskBuilder = onGetMessageTaskBuilder;
        }

        public void setOnGetMessageCallback(com.example.healthmonitoring.TeleportClient.OnGetMessageCallback onGetMessageCallback) {
            this.onGetMessageCallback = onGetMessageCallback;
        }
        //---END MESSAGING ------
